...
@class GADOMIDDevice; @class ASIdentifierManager; @class NSTimeZone; @class NSBundle; @class GADDevice; @class UIViewController; @class UIDevice; @class _TtC9TinderKit7TUIView; @class NSLocale; @class NSFileManager; @class NSJSONSerialization; @class AppsFlyerLib; @class NSData; @class UIScreen; @class _TtC13TinderAuthSMS30EnterPhoneNumberViewController; @class BugsnagDevice; @class UINavigationController; @class USRVDevice; @class UADSMetricCommonTags; @class WKWebView; @class _TtC4Auth29GatedSMSCaptchaViewController; @class NSString; @class NSURL; @class NSObject; @class _TtC11CaptchaView21ArkoseMessageReceiver; @class AppsFlyerUtils; @class NSProcessInfo; @class CTCarrier; 
...
#line 1622 "/Users/wuxiaoping/gitCode/tinder/tinderDylib/Logos/tinderDylib.xm"
