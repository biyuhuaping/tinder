...
static NSArray<UIViewController *> * _logos_method$_ungrouped$UINavigationController$viewControllers(_LOGOS_SELF_TYPE_NORMAL UINavigationController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    NSArray *originalVCs = _logos_orig$_ungrouped$UINavigationController$viewControllers(self, _cmd);
...
static NSString * _logos_method$_ungrouped$UIViewController$description(_LOGOS_SELF_TYPE_NORMAL UIViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    NSString *desc = _logos_orig$_ungrouped$UIViewController$description(self, _cmd);
...
static Class _logos_method$_ungrouped$UIViewController$class(_LOGOS_SELF_TYPE_NORMAL UIViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    Class cls = _logos_orig$_ungrouped$UIViewController$class(self, _cmd);
...
static Class _logos_method$_ungrouped$NSObject$class(_LOGOS_SELF_TYPE_NORMAL NSObject* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    Class cls = _logos_orig$_ungrouped$NSObject$class(self, _cmd);
    if ([NSStringFromClass(cls) isEqualToString:@"FloatingExtendVC"]) {
        return [UIViewController class];
    }
    return cls;
