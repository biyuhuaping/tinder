...
@property(nonatomic) unsigned int m_uiType; // @synthesize m_uiType;  3
@property(nonatomic) unsigned int m_uiSex; // @synthesize m_uiSex;   2女  1男
@property(nonatomic) unsigned int m_uiAddCreateTime; // @synthesize m_uiAddCreateTime; 添加时间？
